...
f(x) = a*x + b
fit f(x) 'time_modules.dat' using 1:2 via a, b
...
linewidth = 3
plot 'time_modules.dat' u 1:2 t 'Reconfiguration time of the h-pyramid relative module count' lt 6 lw linewidth, f(x) lt 4 lw 1
