...
#set terminal png
 ...
 set xlabel "Pyramid Dimension"
#set xlabel "Number of modules in pyramid"
...
set terminal pdf
pdfName = "msg_async_size.pdf"
set output pdfName

linewidth = 2
plot 'msg_size.dat' u  1:2  t 'Number of sent messages (Async)' lt 2 lw linewidth

set terminal pdf
pdfName = "msg_async_size_modules.pdf"
set output pdfName

set xlabel "Number of modules in Pyramid"

plot 'msg_size.dat' u  3:2  t 'Number of sent messages (Async)' lt 2 lw linewidth
