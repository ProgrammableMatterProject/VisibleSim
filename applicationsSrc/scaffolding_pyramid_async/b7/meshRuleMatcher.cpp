...
std::array<Cell3DPosition, 53> MeshRuleMatcher::componentPosition = {
...
const Cell3DPosition MeshRuleMatcher::getPositionForMeshComponent(MeshComponent mc) {
    switch(mc) {
        ...
        case X_1: case X_2: case X_3: case X_4: case X_5: case X_6:
            return Cell3DPosition(1 * (mc - X_1 + 1), 0, 0);

        case Y_1: case Y_2: case Y_3: case Y_4: case Y_5: case Y_6:
            return Cell3DPosition(0, 1 * (mc - Y_1 + 1), 0);

        case Z_1: case Z_2: case Z_3: case Z_4: case Z_5: case Z_6:
            return Cell3DPosition(0, 0, 1 * (mc - Z_1 + 1));

        case RevZ_1: case RevZ_2: case RevZ_3: case RevZ_4: case RevZ_5: case RevZ_6:
