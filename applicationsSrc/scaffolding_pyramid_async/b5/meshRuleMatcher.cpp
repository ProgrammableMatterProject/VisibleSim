...
std::array<Cell3DPosition, 47> MeshRuleMatcher::componentPosition = {
    ...
    Cell3DPosition(-1, -1, 4), // RevZ_EPL
    Cell3DPosition(0, -1, 4), // RevZ_R_EPL

    Cell3DPosition(-4, -1, 4), // RZ_L_EPL
    Cell3DPosition(-3, -1, 4), // RZ_EPL
    Cell3DPosition(-3, 0, 4), // RZ_R_EPL

    Cell3DPosition(-3, -4, 4), // Z_R_EPL
    Cell3DPosition(-3, -3, 4), // Z_EPL
    Cell3DPosition(-4, -3, 4), // Z_L_EPL

    Cell3DPosition(0, -3, 4), // LZ_R_EPL
    Cell3DPosition(-1, -3, 4), // LZ_EPL
    Cell3DPosition(-1, -4, 4), // LZ_L_EPL

    Cell3DPosition(-1, 0, 4), // RevZ_L_EPL
};
...
const Cell3DPosition MeshRuleMatcher::getTargetEPLPositionForBranch(BranchIndex bi) {    
    switch (bi) {
        ...
        case ZBranch: return Cell3DPosition(-1, -1, 4);
        case LZBranch: return Cell3DPosition(-3, -1, 4);
        default:
