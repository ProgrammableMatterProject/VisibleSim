...
void SimpleMotionCode::startup() {
	...
	if (module->position.pt[0]%2==0 && module->position.pt[1]%2==0 && module->position.pt[2]%2==0 ) {
        ...
        members[0] = module;
        members[1] = lattice->getBlock(module->position+Cell3DPosition(1,0,0));
        members[2] = lattice->getBlock(module->position+Cell3DPosition(0,0,1));
        members[3] = lattice->getBlock(module->position+Cell3DPosition(0,0,1));
