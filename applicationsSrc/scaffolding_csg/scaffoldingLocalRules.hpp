...
enum LR_EPL {
    ...
    LR_RevZ_EPL_ALT = LR_RevZ_EPL + 100, // FIXME: TODO: This is due to a conflict with S_Z on iBorders
    LR_RZ_EPL_ALT = LR_RZ_EPL + 100, // FIXME: TODO: This is due to a conflict with S_Z on iBorders
    LR_Z_EPL_ALT = LR_Z_EPL + 100, // FIXME: TODO: This is due to a conflict with S_Z on iBorders
    LR_LZ_EPL_ALT = LR_LZ_EPL + 100, // FIXME: TODO: This is due to a conflict with S_LZ on Y OPP act

    LR_RevZ_EPL_RIGHT = LR_RevZ_EPL + 200, // Used for reaching S_RevZ or R through the righ side of the ZBranch
};
...
static const std::map <const LRKeyTuple, const Cell3DPosition> localMotionRules =
{
    ...
    { LRKeyTuple(0x700, LR_LZ_EPL, Cell3DPosition(1, 1, 0), 3),
      Cell3DPosition(1, 0, 0) }, // S_Z 3 BIS
    ...
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(1, 1, 0), 4),
      Cell3DPosition(1, 0, -1) }, // S_Z 4 BIS
    ...
    { LRKeyTuple(0x220, LR_LZ_EPL, Cell3DPosition(-1, 0, 0), 1),
            Cell3DPosition(-1, -1, 1) }, // OPP_X1 1
    { LRKeyTuple(0x001, LR_LZ_EPL, Cell3DPosition(-1, 0, 0), 2),
    ...
    { LRKeyTuple(0x158, LR_RZ_EPL_ALT, Cell3DPosition(-1, -1, 0), 2),
      Cell3DPosition(-1, 0, 1) }, // S_RevZ 2 ALT
    ...
    // START OPPXY CORNER //
    // R from RevZ_EPL with OppX/OppY
    { LRKeyTuple(0x400, LR_RevZ_EPL_ALT, Cell3DPosition(0, 0, 0), 1),
      Cell3DPosition(1, 0, -1) }, // R 1
    { LRKeyTuple(0x802, LR_RevZ_EPL_ALT, Cell3DPosition(0, 0, 0), 2),
      Cell3DPosition(1, 1, 0) }, // R 2
    { LRKeyTuple(0x048, LR_RevZ_EPL_ALT, Cell3DPosition(0, 0, 0), 3),
      Cell3DPosition(0, 1, 0) }, // R 3
    { LRKeyTuple(0x010, LR_RevZ_EPL_ALT, Cell3DPosition(0, 0, 0), 4),
    ...
    { LRKeyTuple(0x400, LR_LZ_EPL, Cell3DPosition(-1, -1, 0), 5),
      Cell3DPosition(0, 1, -1) }, // S_RevZ 5
    { LRKeyTuple(0x603, LR_LZ_EPL, Cell3DPosition(-1, -1, 0), 6),
      Cell3DPosition(0, -1, 0) }, // S_RevZ 6
    ...
    { LRKeyTuple(0x802, LR_RevZ_EPL_RIGHT, Cell3DPosition(-1, -1, 0), 2),
      Cell3DPosition(-1, 0, 1) }, // S_RevZ 2
    { LRKeyTuple(0x806, LR_RevZ_EPL_RIGHT, Cell3DPosition(-1, -1, 0), 2),
      Cell3DPosition(-1, 0, 1) }, // S_RevZ 2

    { LRKeyTuple(0x201, LR_RZ_EPL_ALT, Cell3DPosition(-1, -1, 0), 1),
      Cell3DPosition(0, -1, 1) }, // S_RevZ 1
    ...
    { LRKeyTuple(0xa00, LR_RZ_EPL, Cell3DPosition(0, 2, 0), 3),
      Cell3DPosition(0, 1, 0) }, // Y2 3 BIS
    ...
    { LRKeyTuple(0xa00, LR_RZ_EPL, Cell3DPosition(0, 3, 0), 3),
      Cell3DPosition(0, 1, 0) }, // Y3 3 BIS
    ...
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(0, 4, 0), 3),
      Cell3DPosition(0, 1, 0) }, // Y4 3
    { LRKeyTuple(0xa00, LR_RZ_EPL, Cell3DPosition(0, 4, 0), 3),
      Cell3DPosition(0, 1, 0) }, // Y4 3 BIS
    ...
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(0, 5, 0), 3),
      Cell3DPosition(0, 1, 0) }, // Y5 3
    { LRKeyTuple(0xa00, LR_RZ_EPL, Cell3DPosition(0, 5, 0), 3),
      Cell3DPosition(0, 1, 0) }, // Y5 3 BIS
    ...
    { LRKeyTuple(0x700, LR_RevZ_EPL, Cell3DPosition(2, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X2 3 BIS
    ...
    { LRKeyTuple(0x700, LR_RevZ_EPL, Cell3DPosition(3, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X3 3 BIS
    ...
    { LRKeyTuple(0x700, LR_RevZ_EPL, Cell3DPosition(4, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X4 3 BIS
    ...
    { LRKeyTuple(0x700, LR_RevZ_EPL, Cell3DPosition(5, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X5 3 BIS
    ...
    { LRKeyTuple(0xb00, LR_LZ_EPL, Cell3DPosition(2, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X2 3
    { LRKeyTuple(0xe00, LR_LZ_EPL, Cell3DPosition(2, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X2 3
    ...
    { LRKeyTuple(0xb00, LR_LZ_EPL, Cell3DPosition(3, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X3 3
    { LRKeyTuple(0xe00, LR_LZ_EPL, Cell3DPosition(3, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X3 3
    ...
    { LRKeyTuple(0xb00, LR_LZ_EPL, Cell3DPosition(4, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X4 3
    { LRKeyTuple(0xe00, LR_LZ_EPL, Cell3DPosition(4, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X4 3
    ...
    { LRKeyTuple(0xb00, LR_LZ_EPL, Cell3DPosition(5, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X5 3
    { LRKeyTuple(0xe00, LR_LZ_EPL, Cell3DPosition(5, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // X5 3
    ...
    // OPP X from Z
    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X1 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_X1 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X1 3
    { LRKeyTuple(0x700, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X1 3 BIS
    { LRKeyTuple(0xf00, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X1 3 TER
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 4),
      Cell3DPosition(0, 1, -1) }, // OPP_X1 4
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 4),
      Cell3DPosition(0, 1, -1) }, // OPP_X1 4 BIS
    { LRKeyTuple(0x700, LR_Z_EPL, Cell3DPosition(-1, 0, 0), 4),
      Cell3DPosition(0, 1, -1) }, // OPP_X1 4 TER

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X2 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_X2 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X2 3
    { LRKeyTuple(0xf00, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X2 3 TER
    { LRKeyTuple(0xe00, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X2 4 TER
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X2 4
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(-2, 0, 0), 5),
      Cell3DPosition(0, 1, -1) }, // OPP_X2 5

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X3 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_X3 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X3 3
    { LRKeyTuple(0xf00, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X3 3 TER
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X3 4
    { LRKeyTuple(0xe00, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X3 4 TER
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 5),
      Cell3DPosition(-1, 0, 0) }, // OPP_X3 5
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(-3, 0, 0), 6),
      Cell3DPosition(0, 1, -1) }, // OPP_X3 6

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X4 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_X4 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X1 3
    { LRKeyTuple(0xf00, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X4 3 TER
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 4
    { LRKeyTuple(0xe00, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 4 TER
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 5),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 5
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 6),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 6
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(-4, 0, 0), 7),
      Cell3DPosition(0, 1, -1) }, // OPP_X4 7

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X5 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_X5 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X1 3
    { LRKeyTuple(0xf00, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_X5 3 TER
    { LRKeyTuple(0xe00, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 4 TER
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 4
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 5),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 5
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 6),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 6
    { LRKeyTuple(0xc00, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 7),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 7
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(-5, 0, 0), 8),
      Cell3DPosition(0, 1, -1) }, // OPP_X5  8

    // OPP Y from Z
    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(0, -1, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y1 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(0, -1, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y1 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(0, -1, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y1 3
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(0, -1, 0), 4),
      Cell3DPosition(1, 0, -1) }, // OPP_Y1 4

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(0, -2, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y2 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(0, -2, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y2 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(0, -2, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y2 3
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -2, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y2 4
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(0, -2, 0), 5),
      Cell3DPosition(1, 0, -1) }, // OPP_Y2 5

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(0, -3, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y3 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(0, -3, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y3 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(0, -3, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y3 3
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -3, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y3 4
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -3, 0), 5),
      Cell3DPosition(0, -1, 0) }, // OPP_Y3 5
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(0, -3, 0), 6),
      Cell3DPosition(1, 0, -1) }, // OPP_Y3 6

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(0, -4, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y4 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(0, -4, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y4 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(0, -4, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y4 3
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -4, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 4
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -4, 0), 5),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 5
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -4, 0), 6),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 6
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(0, -4, 0), 7),
      Cell3DPosition(1, 0, -1) }, // OPP_Y4 7

    { LRKeyTuple(0x110, LR_Z_EPL, Cell3DPosition(0, -5, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y5 1
    { LRKeyTuple(0x100, LR_Z_EPL, Cell3DPosition(0, -5, 0), 2),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y5 2
    { LRKeyTuple(0x500, LR_Z_EPL, Cell3DPosition(0, -5, 0), 3),
      Cell3DPosition(-1, -1, 0) }, // OPP_Y5 3
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -5, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 4
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -5, 0), 5),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 5
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -5, 0), 6),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 6
    { LRKeyTuple(0x600, LR_Z_EPL, Cell3DPosition(0, -5, 0), 7),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 7
    { LRKeyTuple(0x400, LR_Z_EPL, Cell3DPosition(0, -5, 0), 8),
      Cell3DPosition(1, 0, -1) }, // OPP_Y5  8
    ...
    { LRKeyTuple(0xe00, LR_RevZ_EPL, Cell3DPosition(-1, 1, 0), 3),
      Cell3DPosition(0, 1, 0) }, // S_LZ 3 TER
    ...
    { LRKeyTuple(0x300, LR_RevZ_EPL, Cell3DPosition(-1, 1, 0), 4),
      Cell3DPosition(1, 1, -1) }, // S_LZ 4 TER
    ...
    { LRKeyTuple(0x808, LR_RZ_EPL, Cell3DPosition(-1, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X1 1
    { LRKeyTuple(0x800, LR_RZ_EPL, Cell3DPosition(-1, 0, 0), 2),
      Cell3DPosition(-1, 1, 0) }, // OPP_X1 2
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(-1, 0, 0), 3),
      Cell3DPosition(-1, 1, 0) }, // OPP_X1 3
    { LRKeyTuple(0x200, LR_RZ_EPL, Cell3DPosition(-1, 0, 0), 4),
      Cell3DPosition(0, 0, -1) }, // OPP_X1 4

    { LRKeyTuple(0x808, LR_RZ_EPL, Cell3DPosition(-2, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X2 1
    { LRKeyTuple(0x800, LR_RZ_EPL, Cell3DPosition(-2, 0, 0), 2),
      Cell3DPosition(-1, 1, 0) }, // OPP_X2 2
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(-2, 0, 0), 3),
      Cell3DPosition(-1, 1, 0) }, // OPP_X2 3
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-2, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X2 4
    { LRKeyTuple(0x200, LR_RZ_EPL, Cell3DPosition(-2, 0, 0), 5),
      Cell3DPosition(0, 0, -1) }, // OPP_X2 5

    { LRKeyTuple(0x808, LR_RZ_EPL, Cell3DPosition(-3, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X3 1
    { LRKeyTuple(0x800, LR_RZ_EPL, Cell3DPosition(-3, 0, 0), 2),
      Cell3DPosition(-1, 1, 0) }, // OPP_X3 2
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(-3, 0, 0), 3),
      Cell3DPosition(-1, 1, 0) }, // OPP_X3 3
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-3, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X3 4
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-3, 0, 0), 5),
      Cell3DPosition(-1, 0, 0) }, // OPP_X3 5
    { LRKeyTuple(0x200, LR_RZ_EPL, Cell3DPosition(-3, 0, 0), 6),
      Cell3DPosition(0, 0, -1) }, // OPP_X3 6

    { LRKeyTuple(0x808, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X4 1
    { LRKeyTuple(0x800, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 2),
      Cell3DPosition(-1, 1, 0) }, // OPP_X4 2
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 3),
      Cell3DPosition(-1, 1, 0) }, // OPP_X4 3
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 4
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 5),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 5
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 6),
      Cell3DPosition(-1, 0, 0) }, // OPP_X4 6
    { LRKeyTuple(0x200, LR_RZ_EPL, Cell3DPosition(-4, 0, 0), 7),
      Cell3DPosition(0, 0, -1) }, // OPP_X4 7

    { LRKeyTuple(0x808, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_X5 1
    { LRKeyTuple(0x800, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 2),
      Cell3DPosition(-1, 1, 0) }, // OPP_X5 2
    { LRKeyTuple(0xb00, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 3),
      Cell3DPosition(-1, 1, 0) }, // OPP_X5 3
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 4),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 4
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 5),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 5
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 6),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 6
    { LRKeyTuple(0x300, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 7),
      Cell3DPosition(-1, 0, 0) }, // OPP_X5 7
    { LRKeyTuple(0x200, LR_RZ_EPL, Cell3DPosition(-5, 0, 0), 8),
      Cell3DPosition(0, 0, -1) }, // OPP_X5 8

    // OPP Y from LZ
    { LRKeyTuple(0x220, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y1 1
    { LRKeyTuple(0x200, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 2),
      Cell3DPosition(1, -1, 0) }, // OPP_Y1 2
    { LRKeyTuple(0xa00, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y1 3
    { LRKeyTuple(0xa00, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y1 3
    { LRKeyTuple(0xb00, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y1 3 BIS
    { LRKeyTuple(0xf00, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y1 3 TER
    { LRKeyTuple(0xe00, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y1 3 QTR
    { LRKeyTuple(0xc00, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 4),
      Cell3DPosition(0, 0, -1) }, // OPP_Y1 4 TER
    { LRKeyTuple(0x800, LR_LZ_EPL, Cell3DPosition(0, -1, 0), 4),
      Cell3DPosition(0, 0, -1) }, // OPP_Y1 4

    { LRKeyTuple(0x220, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y2 1
    { LRKeyTuple(0x200, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 2),
      Cell3DPosition(1, -1, 0) }, // OPP_Y2 2
    { LRKeyTuple(0xa00, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y2 3
    { LRKeyTuple(0xf00, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y2 3 TER
    { LRKeyTuple(0xd00, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y2 4 TER
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y2 4
    { LRKeyTuple(0x800, LR_LZ_EPL, Cell3DPosition(0, -2, 0), 5),
      Cell3DPosition(0, 0, -1) }, // OPP_Y2 5

    { LRKeyTuple(0x220, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y3 1
    { LRKeyTuple(0x200, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 2),
      Cell3DPosition(1, -1, 0) }, // OPP_Y3 2
    { LRKeyTuple(0xa00, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y3 3
    { LRKeyTuple(0xf00, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y3 3 TER
    { LRKeyTuple(0xd00, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y3 4 TER
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y3 4
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 5),
      Cell3DPosition(0, -1, 0) }, // OPP_Y3 5
    { LRKeyTuple(0x800, LR_LZ_EPL, Cell3DPosition(0, -3, 0), 6),
      Cell3DPosition(0, 0, -1) }, // OPP_Y3 6

    { LRKeyTuple(0x220, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y4 1
    { LRKeyTuple(0x200, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 2),
      Cell3DPosition(1, -1, 0) }, // OPP_Y4 2
    { LRKeyTuple(0xa00, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y4 3
    { LRKeyTuple(0xf00, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y4 3 TER
    { LRKeyTuple(0xd00, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 4 TER
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 4
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 5),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 5
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 6),
      Cell3DPosition(0, -1, 0) }, // OPP_Y4 6
    { LRKeyTuple(0x800, LR_LZ_EPL, Cell3DPosition(0, -4, 0), 7),
      Cell3DPosition(0, 0, -1) }, // OPP_Y4 7

    { LRKeyTuple(0x220 , LR_LZ_EPL, Cell3DPosition(0, -5, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // OPP_Y5 1
    { LRKeyTuple(0x200, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 2),
      Cell3DPosition(1, -1, 0) }, // OPP_Y5 2
    { LRKeyTuple(0xa00, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y5 3
    { LRKeyTuple(0xf00, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 3),
      Cell3DPosition(1, -1, 0) }, // OPP_Y5 3 TER
    { LRKeyTuple(0xd00, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 4 TER
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 4),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 4
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 5),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 5
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 6),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 6
    { LRKeyTuple(0x900, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 7),
      Cell3DPosition(0, -1, 0) }, // OPP_Y5 7
    { LRKeyTuple(0x800, LR_LZ_EPL, Cell3DPosition(0, -5, 0), 8),
      Cell3DPosition(0, 0, -1) }, // OPP_Y5 8

    // R from LZ_EPL right side
    { LRKeyTuple(0x200, LR_LZ_EPL_ALT, Cell3DPosition(0, 0, 0), 1),
      Cell3DPosition(0, -1, 0) }, // R 1
    { LRKeyTuple(0x401, LR_LZ_EPL_ALT, Cell3DPosition(0, 0, 0), 2),
      Cell3DPosition(0, -1, 1) }, // R 2
    { LRKeyTuple(0x020, LR_LZ_EPL_ALT, Cell3DPosition(0, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // R 3

    // R from Z_EPL RIGHT
    { LRKeyTuple(0x400, LR_RevZ_EPL_RIGHT, Cell3DPosition(0, 0, 0), 1),
      Cell3DPosition(1, 0, 0) }, // R 1
    { LRKeyTuple(0x802, LR_RevZ_EPL_RIGHT, Cell3DPosition(0, 0, 0), 2),
      Cell3DPosition(0, 0, 1) }, // R 2
    { LRKeyTuple(0x800, LR_RevZ_EPL_RIGHT, Cell3DPosition(0, 0, 0), 3),
      Cell3DPosition(0, 1, 0) }, // R 3

    // R from Z_EPL Standard
    { LRKeyTuple(0x400, LR_RevZ_EPL, Cell3DPosition(0, 0, 0), 1),
      Cell3DPosition(0, 1, 0) }, // R 1
    { LRKeyTuple(0x201, LR_RevZ_EPL, Cell3DPosition(0, 0, 0), 2),
      Cell3DPosition(0, 0, 1) }, // R 2
    { LRKeyTuple(0x200, LR_RevZ_EPL, Cell3DPosition(0, 0, 0), 3),
      Cell3DPosition(1, 0, 0) }, // R 3
    ...
    { LRKeyTuple(0x404, LR_RevZ_EPL, Cell3DPosition(1, -1, 0), 1),
      Cell3DPosition(-1, -1, 2) }, // S_RZ 1
    { LRKeyTuple(0x400, LR_RevZ_EPL, Cell3DPosition(1, -1, 0), 2),
      Cell3DPosition(1, 0, 0) }, // S_RZ 2
    { LRKeyTuple(0xe00, LR_RevZ_EPL, Cell3DPosition(1, -1, 0), 3),
      Cell3DPosition(1, 0, 0) }, // S_RZ 3
    { LRKeyTuple(0x900, LR_RevZ_EPL, Cell3DPosition(1, -1, 0), 4),
      Cell3DPosition(1, 1, -1) }, // S_RZ 4
};
