...
*/
    ...
    public:
        ...
        */
        ...
        inline virtual DatomsGlBlock *getGlBlock() const override {
        ...
        */
         ...
         * Prefer getNeighborBlock(uint8_t conId) for local neighborhood.
        ...
        **/
        ...
        //  */
        // bool canRotateToPosition(const Cell3DPosition &pos) const;
