...
Nodes2DWorld::Nodes2DWorld(const Cell3DPosition &gridSize, const Vector3D &gridScale,
    ...
    if (GlutContext::GUIisEnabled) {
        objBlock = new ObjLoader::ObjLoader("../../simulatorCore/resources/textures/nodes2DTextures","nodes2D.obj");
        objBlockForPicking = new ObjLoader::ObjLoader("../../simulatorCore/resources/textures/nodes2DTextures","nodes2D_picking.obj");
...
void Nodes2DWorld::createPopupMenu(int ix, int iy) {
    ...
    if (nbreMenus==0) {
        ...
        for(auto &motion:tab) {
            ...
            rotateBlockSubMenu->addButton(new GlutRotation2DButton(NULL,i++,0,0,0,0,"../../simulatorCore/resources/textures/menuTextures/menu_link_nodes2D.tga", motion->isRotation,motion->fromConId,motion->direction+4,finalPos,orient,0.083333333));
        }
    }
