/*
 * catoms3DCapability.h
 *
 *  Created on: 15 janvier 2014
 *      Author: Benoît
 */
#ifndef CATOMS3DCAPABILITY_H_
#define CATOMS3DCAPABILITY_H_
...
class Catoms3DCapabilities {
public:
	vector <Capability*> tabCapabilities;

	Catoms3DCapabilities(TiXmlNode *node);
	~Catoms3DCapabilities();
