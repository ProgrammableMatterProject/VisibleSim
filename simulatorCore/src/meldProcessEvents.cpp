...
VMAddNeighborEvent::VMAddNeighborEvent(uint64_t t, BuildingBlock *conBlock, uint64_t f, uint64_t ta): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
...
VMRemoveNeighborEvent::VMRemoveNeighborEvent(uint64_t t, BuildingBlock *conBlock, uint64_t f): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
...
VMTapEvent::VMTapEvent(uint64_t t, BuildingBlock *conBlock): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
	eventType = EVENT_TAP;
}
...
VMSetColorEvent::VMSetColorEvent(uint64_t t, BuildingBlock *conBlock, float r, float g, float b, float a): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
...
VMSetColorEvent::VMSetColorEvent(uint64_t t, BuildingBlock *conBlock, Vecteur &c): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
	eventType = EVENT_SET_COLOR;
	randomNumber = conBlock->getNextRandomNumber();
	color = c;
...
VMAccelEvent::VMAccelEvent(uint64_t t, BuildingBlock *conBlock, uint64_t xx, uint64_t yy, uint64_t zz): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
...
VMShakeEvent::VMShakeEvent(uint64_t t, BuildingBlock *conBlock, uint64_t f): BlockEvent(t, conBlock) {
	EVENT_CONSTRUCTOR_INFO();
