/*
 * robotBlocksCapability.h
 *
 *  Created on: 15 janvier 2014
 *      Author: Benoît
 */
#ifndef ROBOTBLOCKSCAPABILITY_H_
#define ROBOTBLOCKSCAPABILITY_H_
...
class RobotBlocksCapabilities {
public:
	vector <Capability*> tabCapabilities;

	RobotBlocksCapabilities(TiXmlNode *node);
	~RobotBlocksCapabilities();
