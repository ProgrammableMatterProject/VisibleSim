...
MeldProcessScheduler::MeldProcessScheduler() {
    ...
    OUTPUT << TermColor::LifecycleColor << "MeldProcessScheduler constructor" << endl;
#endif
    state = NOTREADY;
...
MeldProcessScheduler::~MeldProcessScheduler() {
    OUTPUT << TermColor::LifecycleColor << "MeldProcessScheduler destructor" << TermColor::Reset << endl;
}
...
void *MeldProcessScheduler::startPaused(/*void *param*/) {
    ...
    OUTPUT << TermColor::SchedulerColor << "Scheduler : start order received " << systemStartTime << TermColor::Reset << endl;
    ...
    OUTPUT << TermColor::SchedulerColor << "Scheduler end : " << systemStopTime << TermColor::Reset << endl;
    pev.reset();
