...
#ifndef HEXANODEBLOCK_H_
#define HEXANODEBLOCK_H_
...
class HexanodeBlockCode;

/*! \class HexanodeBlock
*/
class HexanodeBlock : public BaseSimulator::BuildingBlock {
public:
...
*/
    HexanodeBlock(int bId, BlockCodeBuilder bcb);
    ~HexanodeBlock();

    inline virtual HexanodeGlBlock* getGlBlock() const override {
        return static_cast<HexanodeGlBlock*>(ptrGlBlock) ;
    };

    inline void setGlBlock(HexanodeGlBlock*ptr) { ptrGlBlock=ptr;};
